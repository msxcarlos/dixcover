...
Mat Omens::textDetection(const Mat &image) {
    ...
    Ptr<ERFilter> er_filter1 = createERFilterNM1(loadClassifierNM1("../resources/trained_classifierNM1.xml"),8,0.00015f,0.13f,0.2f,true,0.1f);
    Ptr<ERFilter> er_filter2 = createERFilterNM2(loadClassifierNM2("../resources/trained_classifierNM2.xml"),0.5);
